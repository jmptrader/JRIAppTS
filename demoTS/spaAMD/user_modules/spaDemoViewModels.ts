...
export interface IMyGridEvents extends COMMON.IGridEvents {
    destroy(): void;
    focusGrid(): void;
}
...
export class CustomerGridEvents extends RIAPP.BaseObject implements IMyGridEvents {
...
export class CustomerVM extends MOD.mvvm.BaseViewModel {
    ...
    private _editCommand: MOD.mvvm.ICommand;
    private _endEditCommand: MOD.mvvm.ICommand;
    private _cancelEditCommand: MOD.mvvm.ICommand;
    ...
    private _uiMainView: MainViewVM;
    private _uiDetailView: CustDetViewVM;
    private _switchViewCommand: MOD.mvvm.ICommand;
    private _switchDetViewCommand: MOD.mvvm.ICommand;
    private _gridEvents: IMyGridEvents;
...
//we communicate with the dataGrid through this object
//achieving a loose coupling between UI control and a ViewModel
export class OrderGridEvents extends RIAPP.BaseObject implements IMyGridEvents {
...
export class CustomerAddressVM extends MOD.mvvm.BaseViewModel {
    ...
    private _addressesView: MOD.db.DataView<DEMODB.Address>;
...
export class AddAddressVM extends MOD.mvvm.BaseViewModel implements RIAPP.ISubmittable {
    ...
    private _adressInfosGrid: MOD.datagrid.DataGrid;
    private _searchString: string;
    private _dialogVM: MOD.datadialog.DialogVM;
    private _addressInfosView: MOD.db.DataView<DEMODB.AddressInfo>;
    private _linkCommand: MOD.mvvm.ICommand;
    private _addNewCommand: MOD.mvvm.ICommand;
    private _unLinkCommand: MOD.mvvm.ICommand;
    private _execSearchCommand: MOD.mvvm.ICommand;
    private _addNewAddressCommand: MOD.mvvm.ICommand;
    private _propChangeCommand: MOD.mvvm.ICommand;
    private _uiViewVM: AddrViewVM;
    ...
    protected _checkAddressInRP(addressID) {
    ...
    protected _removeAddressRP(addressID) {
