...
namespace RIAPP.DEMODB {
    'use strict';
    /*
        Generated from: /RIAppDemoService/code?lang=ts on 2015-09-24 at 11:30
    ...
    */
    ...
    //******BEGIN LISTS REGION******
    export class TestModelListItem extends collMOD.CollectionItem<collMOD.ListItemAspect<TestModelListItem, IClientTestModel>> implements collMOD.IListItem, IClientTestModel {
    ...
    export class TestDictionary extends collMOD.BaseDictionary<TestModelListItem, IClientTestModel> {
        constructor() {
    ...
    export class TestList extends collMOD.BaseList<TestModelListItem, IClientTestModel> {
        constructor() {
    ...
    export class KeyValListItem extends collMOD.CollectionItem<collMOD.ListItemAspect<KeyValListItem, IKeyVal>> implements collMOD.IListItem, IKeyVal {
    ...
    export class KeyValDictionary extends collMOD.BaseDictionary<KeyValListItem, IKeyVal> {
        constructor() {
    ...
    export class StrKeyValListItem extends collMOD.CollectionItem<collMOD.ListItemAspect<StrKeyValListItem, IStrKeyVal>> implements collMOD.IListItem, IStrKeyVal {
        get key(): string { return <string>this._aspect._getProp('key'); }
        set key(v: string) { this._aspect._setProp('key', v); }
        get val(): string { return <string>this._aspect._getProp('val'); }
        set val(v: string) { this._aspect._setProp('val', v); }
    ...
    export class StrKeyValDictionary extends collMOD.BaseDictionary<StrKeyValListItem, IStrKeyVal> {
        constructor() {
    ...
    export class RadioValListItem extends collMOD.CollectionItem<collMOD.ListItemAspect<RadioValListItem, IRadioVal>> implements collMOD.IListItem, IRadioVal {
        get key(): string { return <string>this._aspect._getProp('key'); }
        set key(v: string) { this._aspect._setProp('key', v); }
    ...
    export class RadioValDictionary extends collMOD.BaseDictionary<RadioValListItem, IRadioVal> {
        constructor() {
    ...
    export class HistoryItemListItem extends collMOD.CollectionItem<collMOD.ListItemAspect<HistoryItemListItem, IHistoryItem>> implements collMOD.IListItem, IHistoryItem {
    ...
    export class HistoryList extends collMOD.BaseList<HistoryItemListItem, IHistoryItem> {
        constructor() {
    ...
    export class Customer extends collMOD.CollectionItem<dbMOD.EntityAspect<Customer, DbContext>> implements dbMOD.IEntityItem {
    ...
    export class CustomerAddress extends collMOD.CollectionItem<dbMOD.EntityAspect<CustomerAddress, DbContext>> implements dbMOD.IEntityItem {
    ...
    export class Address extends collMOD.CollectionItem<dbMOD.EntityAspect<Address, DbContext>> implements dbMOD.IEntityItem {
    ...
    export class Product extends collMOD.CollectionItem<dbMOD.EntityAspect<Product, DbContext>> implements dbMOD.IEntityItem {
    ...
    export class ProductModel extends collMOD.CollectionItem<dbMOD.EntityAspect<ProductModel, DbContext>> implements dbMOD.IEntityItem {
    ...
    export class SalesOrderHeader extends collMOD.CollectionItem<dbMOD.EntityAspect<SalesOrderHeader, DbContext>> implements dbMOD.IEntityItem {
    ...
    export class SalesOrderDetail extends collMOD.CollectionItem<dbMOD.EntityAspect<SalesOrderDetail, DbContext>> implements dbMOD.IEntityItem {
    ...
    export class ProductCategory extends collMOD.CollectionItem<dbMOD.EntityAspect<ProductCategory, DbContext>> implements dbMOD.IEntityItem {
    ...
    export class SalesInfo extends collMOD.CollectionItem<dbMOD.EntityAspect<SalesInfo, DbContext>> implements dbMOD.IEntityItem {
    ...
    export class LookUpProduct extends collMOD.CollectionItem<dbMOD.EntityAspect<LookUpProduct, DbContext>> implements dbMOD.IEntityItem {
    ...
    export class AddressInfo extends collMOD.CollectionItem<dbMOD.EntityAspect<AddressInfo, DbContext>> implements dbMOD.IEntityItem {
